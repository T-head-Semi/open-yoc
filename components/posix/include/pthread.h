...
#ifndef USE_AOS_NEW_HDL_DEF
// need match in aos/kernel.h
typedef struct {
    void *hdl;
} ahdl_t;
#else
...
#ifndef USE_AOS_NEW_HDL_DEF
#define PTHREAD_MUTEX_INITIALIZER {PTHREAD_STATIC_INIT, {0}, {0}}
#define PTHREAD_COND_INITIALIZER  {PTHREAD_STATIC_INIT, 0, 0, {0}, {0}, {0}, {0}}
#else
