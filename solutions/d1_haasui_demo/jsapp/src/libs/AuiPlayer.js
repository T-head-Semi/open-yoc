...
class AuiPlayer extends events.EventEmitter {
    ...
    constructor(type, options) {
        ...
        this._evtIfaceGotBind = this._evtIfaceGot.bind(this);
        this._evtPlayErrorBind = this._evtPlayError.bind(this);
        this._evtPlayStartBind = this._evtPlayStart.bind(this);
        this._evtPlayPauseBind = this._evtPlayPause.bind(this);
        this._evtPlayResumeBind = this._evtPlayResume.bind(this);
        this._evtPlayStopBind = this._evtPlayStop.bind(this);
        this._evtPlayFinishBind = this._evtPlayFinish.bind(this);
        this._evtPlayUnderRunBind = this._evtPlayUnderRun.bind(this);
        this._evtPlayOverRunBind = this._evtPlayOverRun.bind(this);
        this._evtPlayMuteBind = this._evtPlayMute.bind(this);
        this._evtPlayVolChangeBind = this._evtPlayVolChange.bind(this);
        ...
        if (this._interf) {
            ...
            MediaDbus.getInstance().on(MediaDbusEvent.IFACE_GOT, this._evtIfaceGotBind);
        }
    }
    ...
    _lisen() {
        if (this._interf) {
            this._interf.on('PlayError', this._evtPlayErrorBind);
            this._interf.on('PlayStart', this._evtPlayStartBind);
            this._interf.on('PlayPause', this._evtPlayPauseBind);
            this._interf.on('PlayResume', this._evtPlayResumeBind);        
            this._interf.on('PlayStop', this._evtPlayStopBind);
            this._interf.on('PlayFinish', this._evtPlayFinishBind);
            this._interf.on('PlayUnderRun', this._evtPlayUnderRunBind);   
            this._interf.on('PlayOverRun', this._evtPlayOverRunBind);  
            this._interf.on('PlayMute', this._evtPlayMuteBind);          
            this._interf.on('PlayVolChange', this._evtPlayVolChangeBind);  
        }       
    }

    _unlisen() {
        if (this._interf) {
            this._interf.off('PlayError', this._evtPlayErrorBind);
            this._interf.off('PlayStart', this._evtPlayStartBind);
            this._interf.off('PlayPause', this._evtPlayPauseBind);
            this._interf.off('PlayResume', this._evtPlayResumeBind);        
            this._interf.off('PlayStop', this._evtPlayStopBind);
            this._interf.off('PlayFinish', this._evtPlayFinishBind);
            this._interf.off('PlayUnderRun', this._evtPlayUnderRunBind);   
            this._interf.off('PlayOverRun', this._evtPlayOverRunBind);  
            this._interf.off('PlayMute', this._evtPlayMuteBind);          
            this._interf.off('PlayVolChange', this._evtPlayVolChangeBind);   
        }      
    }
    ...
    /**
     * @description: deconstructor the player
     * @return {*}
     */
    destroy() {
        if (this._interf) {
            this._unlisen();
            MediaDbus.getInstance().off(MediaDbusEvent.IFACE_GOT, this._evtIfaceGotBind);
            return;
        }
    }
}
